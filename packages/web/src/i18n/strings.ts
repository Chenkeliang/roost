...
export const STRINGS: Record<string, { en: string; zh: string }> = {
  ...
  "ai.preview.encrypted": { en: "encrypted entry — preview disabled (secrets never shown in UI)", zh: "加密项不提供预览(密钥不在界面显形)" },
  "ai.preview.binary": { en: "binary file — no preview", zh: "二进制文件,无预览" },
