...
export const STRINGS: Record<string, { en: string; zh: string }> = {
  ...
  "sync.defaultAction": { en: "Default action", zh: "默认怎么处理" },
  "sync.useRepo": { en: "Use repo version", zh: "用仓库版" },
  "sync.keepLocal": { en: "Keep local", zh: "保留本地" },
  "sync.backupNote": { en: "Backed up before overwrite", zh: "覆盖前全部备份" },
  "sync.autoLabel": { en: "Auto", zh: "自动" },
  "sync.decideLabel": { en: "Needs you", zh: "需你决定" },
  "sync.applyAll": { en: "Apply default to all", zh: "全部应用默认" },
  ...
  "sync.dir.ahead": { en: "To back up", zh: "待备份" },
  "sync.dir.behind": { en: "To restore", zh: "待恢复" },
  "sync.dir.diverged": { en: "Conflicts", zh: "有冲突" },
  // groups
  "sync.group.auto": { en: "Will auto-restore (repo is newer)", zh: "将自动恢复(仓库较新)" },
  "sync.group.diverged": { en: "Conflict — changed on both sides", zh: "有冲突:两边都改了" },
  "sync.group.blocked": { en: "Needs setup (missing age key / tool)", zh: "需先设置(缺 age 私钥 / 工具)" },
  "sync.group.destructive": { en: "Removed in the repo", zh: "仓库已删除此项" },
  // diff pane
  ...
  "sync.notice.usedRepo": { en: "Used repo version", zh: "已用仓库版" },
  "sync.notice.usedSuffix": { en: "(backed up before overwrite)", zh: "(覆盖前已备份)" },
  "sync.notice.batchDone": { en: "Batch done — resolved", zh: "批量完成:处理" },
  "sync.notice.itemsWord": { en: "item(s)", zh: "项" },
  "sync.notice.batchSuffix": { en: "(destructive kept local)", zh: "(破坏性项已保留本地)" },
