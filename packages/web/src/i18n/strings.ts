...
export const STRINGS: Record<string, { en: string; zh: string }> = {
  ...
  "settings.key.rotateConfirmTitle": { en: "Rotate the age key?", zh: "更换 age 密钥?" },
  "settings.key.rotateConfirmYes": { en: "Rotate now", zh: "立即更换" },
  "settings.key.rotateConfirmCancel": { en: "Cancel", zh: "取消" },
  ...
  "preview.revealedNote": { en: "values shown — local only (repo stays encrypted)", zh: "明文已显示 · 仅本地查看(仓库仍为密文)" },
  "preview.revealAria": { en: "Show value", zh: "显示明文" },
  "preview.hideAria": { en: "Hide value", zh: "隐藏明文" },
